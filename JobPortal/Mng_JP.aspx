<%@ Page Title="" Language="C#" MasterPageFile="~/Adm.Master" AutoEventWireup="true" CodeBehind="Mng_JP.aspx.cs" Inherits="JobPortal.Mng_JobPost" %>
            ...
            <td>
                <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" OnRowCommand="Grd_RowCommand" Width="1200px">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkapprove" runat="server" Text='<%#Eval("status").ToString()=="0" ? "Not Approved" : "Approved" %>' CommandArgument='<%#Eval("rid") %>' CommandName="APR" OnClientClick="return confirm('Are you sure you want to approve ?')"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
