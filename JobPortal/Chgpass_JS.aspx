<%@ Page Title="" Language="C#" MasterPageFile="~/JS.Master" AutoEventWireup="true" CodeBehind="Chgpass_JS.aspx.cs" Inherits="JobPortal.Chgpass_Emp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtconpass" runat="server"></asp:TextBox></td>
        </tr>
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="Btnchgpass" runat="server" Text="Change Password" OnClick="Btnchgpass_Click" OnClientClick="return JSval()" />
        </tr>
    </table>
</asp:Content>
